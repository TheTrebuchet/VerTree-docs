...
**TreeGen** is a Blender addon for all the environment artist out there. This addon enables the user to create complex trees quickly, whether it be for background or foreground. It is meant to give a basic or complex tree mesh quickly. 
